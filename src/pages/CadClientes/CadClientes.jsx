...
const CadClientes = () => {
  const [inputEmail, setInputEndereco] = useState("");
  const [inputCPF, setInputCPF] = useState("");
  const [inputNome, setInputNome] = useState("");
  const [inputTel, setInputTel] = useState("");
  const [inputGenero, setInputGenero] = useState("");

  function handleInputEndereco(target) {
    setInputEndereco(target.value);
  ...
  //   if (
  //     inputEmail.indexOf("@") > 2 &&
  //     inputEmail.indexOf(".com") > inputEmail.indexOf("@")
  //   ) {
  //     //alert("Email Válido")
  //   } else {
    ...
    <section className="cadastro">
      ...
      <form className="formCadastro">
        ...
        <input
          ...
          type="text"
          value={inputTel}
          onChange={({ target }) => handleInputTel(target)}
        />
        ...
        <input
          ...
          type="text"
          value={inputEmail}
          onChange={({ target }) => handleInputEndereco(target)}
        />
        ...
        <div className="radioInput">
          <input
            ...
            name="genero"
            value="masculino"
            onChange={({ target }) => handleInputGenero(target)}
          />
